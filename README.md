...
Результат можно разукрасить для визуального поиска оптимальной комбинации модель-данныe:
Мы видим перспективные алгоритмы. Видим индексы сэмплов, на которых модели показывают лучший результат.
...
Найдено несколько решений, 3 вошли финальный репозиторий. Из них 2 на основе модели SVM и один на основе нейросети LSTM.  
